...
export default function DraftPage() {
  ...
  const canWrite =
    sowPermissions === null || sowPermissions.includes('*') || sowPermissions.includes('sow.write');

  const canRead = sowPermissions === null || canWrite || sowPermissions.includes('sow.read');
